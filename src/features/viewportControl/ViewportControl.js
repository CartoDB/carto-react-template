...
import { setViewState } from "../map/mapSlice";
    ...
    <div className={styles.ViewportControl}>
      ...
      <label>
        <input
          ...
          onChange={(event) => dispatch(setViewState({ zoom: event.target.valueAsNumber }))}
        ></input>
        Zoom
      </label>
      <label>
        <input
          ...
          onChange={(event) => dispatch(setViewState({ pitch: event.target.valueAsNumber }))}
        ></input>
        Pitch
      </label>
      <label>
        <input
          ...
          onChange={(event) => dispatch(setViewState({ bearing: event.target.valueAsNumber }))}
        ></input>
        Bearing
      </label>
    </div>
